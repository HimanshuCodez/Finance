...
export default function SocialHandles() {
  return (
    <div className="fixed bottom-4 right-4 flex flex-col gap-4">
      <a href="https://www.facebook.com/share/17vAbA1HH6/" target="_blank" rel="noopener noreferrer" className="bg-blue-600 text-white p-3 rounded-full shadow-lg hover:bg-blue-700 transition">
